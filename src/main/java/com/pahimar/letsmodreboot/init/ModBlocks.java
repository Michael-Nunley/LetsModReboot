...
import com.pahimar.letsmodreboot.block.BlockPyramid;
...
public class ModBlocks
{
    ...
    public static final BlockPyramid pyramid = new BlockPyramid();

    public static void init()
    {
        GameRegistry.registerBlock(flag, Names.Blocks.FLAG);
        GameRegistry.registerBlock(pyramid, Names.Blocks.PYRAMID);
    }
}
